...
public class HttpServerTest {
    ...
    public void testTasksEndpoint() throws IOException, InterruptedException {
        ...
        assertEquals("taskname 1", tasksFromManager.get(0).getTaskName(), "Некорректное имя задачи");
        ...
        assertEquals(2, tasksFromManager1.get(0).getTaskId(), "Удаление не прошло");
    }
    ...
    public void testEpicsEndpoint() throws IOException, InterruptedException {
        ...
        assertEquals("epicname1", epicsFromManager.get(0).getTaskName(), "Некорректное имя задачи");
        ...
        assertEquals(2, epicsFromManager1.get(0).getTaskId(), "Удаление не прошло");
    ...
    public void testSubtasksEndpoint() throws IOException, InterruptedException {
        ...
        List<Epic> epicsFromManager = manager.getEpics();
        assertEquals("IN_PROGRESS", epicsFromManager.get(0).getTaskStatus().toString());
        ...
        assertEquals("subtaskname1", subtasksFromManager.get(0).getTaskName(), "Некорректное имя задачи");
        ...
        assertEquals(2, subtasksFromManager.get(0).getTaskId(), "Удаление не прошло");
        assertEquals("DONE", epicsFromManager.get(0).getTaskStatus().toString());
    ...
    public void testProiritizedEndpoint() throws IOException, InterruptedException {
        ...
        assertEquals("subtaskname1", prioritizedTasksFromManager.get(0).getTaskName(), "Некорректное имя задачи");
    ...
    public void testHistoryEndpoint() throws IOException, InterruptedException {
        ...
        assertEquals("subtaskname1", historyFromManager.get(0).getTaskName(), "Некорректное имя задачи");
